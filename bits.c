...
int isGreater(int x, int y) {
  ...
  mask1=(x>>31)^(y>>31);//0 xiang tong; 1 bu tong;
  mask2=~(x>>31)&mask1;//x>0,y<0==11111
  mask3=y+(~x+1);//y>=x,>0
  mask3=mask3>>31;//y>=x 0;y<x, 1;
  mask4=(mask3)&(~mask1);
  return(!!mask2)|(!!mask4);
}
/* 
...
unsigned float_neg(unsigned uf) {
  ...
  mask1=uf&0x7fffffff;
  mask2=mask1>>23;
  if(!(mask2^0xff)&&(mask1^0x7f800000))
  return uf;
